...
export default ({ collapsed, isMobileOpen }) => {
  ...
  const adminLinks = [
    ...
    { to: '/admin/manage-interviewers', label: 'Manage Team', icon: <Users size={18} /> },
    ...
    { to: '/admin/ai-conflict', label: 'AI Conflict Detection', icon: <ShieldAlert size={18} /> },
    { to: '/admin/ai-insights', label: 'AI Insights', icon: <BarChart4 size={18} /> },
    { to: '/admin/ai-reminders', label: 'AI Reminders', icon: <Mail size={18} /> },
  ];
